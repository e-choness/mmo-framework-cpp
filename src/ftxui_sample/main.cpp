...
// configuration step. It creates a namespace called `tiny_rpg`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", tiny_rpg::cmake::project_name, tiny_rpg::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", tiny_rpg::cmake::project_version);
      return EXIT_SUCCESS;
    }
